...
Locator: locator('section').filter({ has: getByRole('heading', { name: /Featured Properties/i }) }).locator('a').first().locator('..').locator('button, a').filter({ hasText: /View Details/i })
Expected: visible
Error: strict mode violation: locator('section').filter({ has: getByRole('heading', { name: /Featured Properties/i }) }).locator('a').first().locator('..').locator('button, a').filter({ hasText: /View Details/i }) resolved to 2 elements:
    1) <a href="/en/property/lakeside-sereni">…</a> aka getByRole('link', { name: 'View Details' }).first()
    2) <button class="bg-cyan-500 hover:bg-cyan-600 text-white text-xs md:text-sm font-bold px-4 md:px-5 py-2.5 md:py-3 rounded-lg transition-colors duration-300 flex-shrink-0">View Details</button> aka getByRole('button', { name: 'View Details' }).first()

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('section').filter({ has: getByRole('heading', { name: /Featured Properties/i }) }).locator('a').first().locator('..').locator('button, a').filter({ hasText: /View Details/i })

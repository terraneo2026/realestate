...
- Name: security\rbac.spec.ts >> RBAC & Security >> owner should not be able to access agent-only APIs
- Location: tests\security\rbac.spec.ts:17:7
...
Expected pattern: /\/en\/owner\/dashboard/
    ...
    - generic [ref=e36]:
      - generic [ref=e37]:
        - generic [ref=e38]:
          ...
          - generic [ref=e40]:
            - img [ref=e41]
            - textbox "name@example.com" [ref=e44]: owner@relocate.biz
        - generic [ref=e45]:

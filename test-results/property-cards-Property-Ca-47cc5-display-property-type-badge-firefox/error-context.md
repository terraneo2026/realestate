...
Locator:  locator('text=/Villa|House|Apartment/').first()
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('text=/Villa|House|Apartment/').first()
    8 × locator resolved to <option value="apartment">Apartment</option>

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <a href="mailto:adminn@ebroker.in" className="flex items-center gap-1 hover:opacity-80 transition">
                <span>📧</span>
                adminn@ebroker.in
              </a>
              <a href="tel:7874664341" className="flex items-center gap-1 hover:opacity-80 transition">
                <span>📱</span>
                7874664341
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 md:py-4">
          <div className="flex items-center justify-between gap-2 md:gap-4">
            ...
            <Link href={`/${locale}`} className="flex items-center gap-2 z-10 flex-shrink-0">
              ...
              <span className="text-lg md:text-2xl font-bold primaryColor hidden sm:inline">eBroker</span>
            </Link>

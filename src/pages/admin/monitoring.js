            ...
            <div className="relative z-10">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
                  <div className="space-y-4">
                     <span className="text-xs font-bold text-gray-400 tracking-tight">CPU load</span>
                  ...
                  <div className="space-y-4">
                     <span className="text-xs font-bold text-gray-400 tracking-tight">Memory usage</span>
                  ...
                  <div className="space-y-4">
                     <span className="text-xs font-bold text-gray-400 tracking-tight">Disk I/O</span>
               ...
               <div className="p-6 bg-white/5 rounded-2xl border border-white/5 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                     ...
                     <span className="text-xs font-bold tracking-tight">Network throughput</span>
                  </div>
               ...
               <div className="space-y-6">
                  {[
                    ...
                    <div key={i} className="flex justify-between items-center py-4 border-b border-gray-50 last:border-0">
                       <span className="text-xs font-bold text-gray-400 tracking-tight">{item.event}</span>
                       <span className={cn("text-xs font-bold tracking-tight", item.color)}>{item.status}</span>
                    </div>
                  ))}
               </div>
            </div>
